...
gear_ratios = linspace(1, 30, 100); % ratios
...
figure
yyaxis left
plot(gear_ratios, motor_speed_rpm, 'LineWidth', 1.5)
ylabel('Motor Speed [RPM]')
yyaxis right
plot(gear_ratios, motor_torque_max * 16, 'LineWidth', 1.5)
hold on
plot(gear_ratios, motor_torque_rms * 16, 'LineWidth', 1.5)
...
grid on
box off
legend('Motor Speed','Peak Torque','RMS Torque','Location','best')
